...
class DoctrineEntityNormalizerTest extends SerializerTest
{
    ...
    public function testPropertyDenormalizationForManyToOneAssociation()
    {
        ...
        $this->expectToBeReferenced(OtherEntity::class, 1234, new OtherEntity(1234, 'from em'));
 ...
 /**
    ...
    public function testPropertyDenormalizationForManyToManyAssociation()
    {
        ...
        $this->expectToBeReferenced(OtherEntity::class, 1234, new OtherEntity(1234, 'from em'));
        $this->expectToBeReferenced(OtherEntity::class, 5678, new OtherEntity(5678, 'from em'));
